...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog='Пример: python main.py program.yaml output.bin --test'
    )
...
def _run_specification_tests(assembler):
    """Запускает тесты из спецификации УВМ"""
    test_cases = [
        ("LOAD 569", {"command": "LOAD", "value": 569}, [0x68, 0x8E, 0x00, 0x00]),
        ("READ", {"command": "READ"}, [0x1F, 0x00, 0x00, 0x00]),
        ("WRITE 399", {"command": "WRITE", "address": 399}, [0x69, 0x63, 0x00, 0x00]),
        ("NOT 887", {"command": "NOT", "address": 887}, [0xD3, 0xD0, 0x00, 0x00]),
    ]
